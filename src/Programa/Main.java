...
public class Main {
	...
	public static void afegirArticle(Floristeria floristeria) {
		...
		byte opcio=menuTipus();
		while(opcio!=0) {
			id = floristeria.getIdArticle();
			if(opcio==1) {				
	...
	public static void triaArticleRetirar(Floristeria floristeria) {
		...
		while(opcio!=0) {
			if(opcio==1) {
				System.out.println(floristeria.mostraArbres());
			}else if(opcio==2) {
				System.out.println(floristeria.mostraFlors());
			}else {
				System.out.println(floristeria.mostraDecoracions());
			}
	...
	public static void imprimirQuatitatStock(Floristeria floristeria){
		...
		System.out.println("      "+floristeria.getStockArbres());
		System.out.println("FLORS:");
		System.out.println("      "+floristeria.getStockFlors());
		System.out.println("DECORACIONS:");
		System.out.println("      "+floristeria.getStockDecoracions());
	}
